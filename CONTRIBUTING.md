...
issue](https://github.com/cisagov/cool-iam-user-group-manager-iam/issues) in this
...
request](https://github.com/cisagov/cool-iam-user-group-manager-iam/pulls), you
...
```console
cd cool-iam-user-group-manager-iam
pyenv virtualenv <python_version_to_use> cool-iam-user-group-manager-iam
pyenv local cool-iam-user-group-manager-iam
