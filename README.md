...
```hcl
module "example" {
  source = "github.com/cisagov/cool-iam-user-group-manager-iam"
...
- [Basic usage](https://github.com/cisagov/cool-iam-user-group-manager-iam/tree/develop/examples/basic_usage)
